  ...
  <body>
    ...
    <main class="main-content">
        ...
        <div id="product">
          <div id="links">
            <a href="/php/index.php" id="i"
              >Início
              <a href="/php/product1.php">> Slug t-shirt black</a></a
            >
          </div>
          <img
      ...
      <div id="sub-container">
        ...
        <div id="product">
          <a href="/php/product2.php"><img src="/Img/produto-2.jpg" alt="product-2" id="product-2">
          <br>
          <div id="position">
            <p id="product-infos-2">Slug T-shirt Off-white</p> 
